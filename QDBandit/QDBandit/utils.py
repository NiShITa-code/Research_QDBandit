...
from QDBandit.switcher import LLMSwitcher
...
def save_iteration_log(
    ...
    """
    if iteration == -1:
        log_path = log_dir / f"qdbandit_log_{timestamp}.json"
    else:
        log_path = log_dir / f"qdbandit_log_{timestamp}_epoch_{iteration+1}.json"
